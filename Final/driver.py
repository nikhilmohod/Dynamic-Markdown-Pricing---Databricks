...
# MAGIC ############################################
# MAGIC LLM_ENDPOINT_NAME = "databricks-claude-sonnet-4-6"
# MAGIC
# MAGIC SYSTEM_PROMPT = """You are a Retail Markdown Pricing Advisor.
# MAGIC
# MAGIC Use available tools to answer questions about:
# MAGIC
# MAGIC - markdown recommendations
# MAGIC - inventory optimization
# MAGIC - trend analysis
# MAGIC - pricing decisions
# MAGIC - profit optimization
# MAGIC
# MAGIC Always explain the business reason behind markdown recommendations."""
# MAGIC
# MAGIC
# MAGIC ###############################################################################
...
# MAGIC UC_TOOL_NAMES = ["team_data-pirates_catalog.hackathon.get_profit"],
# MAGIC UC_TOOL_NAMES = ["team_data-pirates_catalog.hackathon.markdown"],
# MAGIC UC_TOOL_NAMES = ["team_data-pirates_catalog.hackathon.get_trending_products"],
# MAGIC UC_TOOL_NAMES = ["team_data-pirates_catalog.hackathon.get_overstock_products"],
# MAGIC UC_TOOL_NAMES = ["team_data-pirates_catalog.hackathon.markdown"]
# MAGIC
